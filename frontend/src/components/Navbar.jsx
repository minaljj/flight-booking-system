          ...
          {user ? (
            ...
            <div className="flex items-center gap-2">
              <Link to="/signup" className="hidden sm:block">
                <Button className="bg-emerald-600 hover:bg-emerald-700 text-white font-black text-xs uppercase tracking-widest h-10 px-6 rounded-xl shadow-lg shadow-emerald-500/20 border-none transition-all">
                  Sign Up
                </Button>
              </Link>
              <Link to="/login">
                <Button className="bg-blue-600 hover:bg-blue-700 text-white font-black text-xs uppercase tracking-widest h-10 px-6 rounded-xl shadow-lg shadow-blue-500/20 border-none transition-all">
                  Log In
                </Button>
              </Link>
            </div>
